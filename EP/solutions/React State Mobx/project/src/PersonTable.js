      ...
      <div className="">
        <div className="row">
          <div className="col s6 right-align">
            <a onClick={this.updateTableThirdSecond} className="waves-effect waves-light green lighten-2 btn"><i className="material-icons right">cloud</i>Start updating</a>
          </div>
